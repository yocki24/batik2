                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row mb-3">
                      ...
                      <a href="javascript:void(0)" onclick="window.history.back()" class="btn btn-dark">Kembali</a>
                      </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{ route('pengrajin.product.update',['id' => $product->id]) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="text-right">
                                    <button type="submit" class="btn btn-success text-right"><strong>Simpan</strong></button>
                                </div>
                            </form>
                        </div>
                    </div>
