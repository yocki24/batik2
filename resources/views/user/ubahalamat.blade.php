...
<div class="bg-light py-3">
    <div class="container">
    <div class="row">
        <span class="mx-2 mb-0">/</span> <strong class="text-black">Setting Alamat</strong></div>
    </div>
    </div>
</div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @csrf
                        ...
                        <button type="submit" class="btn btn-dark"><strong>Simpan Perubahan</strong></button>
                        </div>
                    </form>
                </div>
            </div>
