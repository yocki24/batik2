...
@section('title', __('report.monthly', ['year_month' => $months[$month - 1] . ' ' . $year]))
            ...
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        ...
                        {{ link_to_route('ketua.reports.sales.monthly', __('Lihat laporan bulan ini'), [], ['class' => 'ml-5 sm']) }}
                        {{ link_to_route('ketua.reports.sales.yearly', __('Lihat laporan tahun ini'), ['year' => $year], ['class' => 'ml-5 sm']) }}
                        {{ Form::close() }}
                        <hr>
                        {{ Form::open(['method' => 'get', 'class' => 'form-inline well well-sm']) }}
                        ...
                        <div class="panel panel-primary mt-2 mb-4">
                            <div class="panel-heading">
                                <h3 class="panel-title">{{ __('Data Rekap Penjualan Bulan') }}
                                    {{ $months[$month - 1] }}
                                    {{ $year }}</h3>
                            </div>
