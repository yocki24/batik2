...
@section('title', __('laporan_bulanan.daily', ['date' => date_id($date)]))
...
{{ Form::label('date', __('laporan_bulanan.view_daily_label'), ['class' => 'control-label']) }}
...
{{ link_to_route('laporan_bulanan.daily', __('laporan_bulanan.today'), [], ['class' => 'btn btn-default btn-sm']) }}
{{ link_to_route(
    'laporan_bulanan.sales.monthly',
