          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <h3><strong> Batik Ciprat Langitan Simbatan </strong></h3>
                </div>
                <h6>Baru disini?</h6>
                ...
                @enderror
                  ...
                  <div class="text-center mt-4 font-weight-light"> Sudah memiliki akun? <a href="login.html" class="text-orange">Login</a>
                  </div>
                </form>
              </div>
            </div>
